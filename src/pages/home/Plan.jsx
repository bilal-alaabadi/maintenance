  ...
  return (
    ...
    <div className="flex flex-col gap-6 md:flex-row">
      {plans.map((plan, index) => (
        <div 
          key={index} 
          className="flex-1 bg-white p-6 rounded-xl shadow-md hover:shadow-lg flex flex-col justify-between min-h-[550px] transition-all transform hover:scale-105 overflow-hidden"
        >
          <div>
            <h2 
